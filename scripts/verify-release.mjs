...
if (rootPackage.scripts?.["smoke:query-values"] !== "npm run smoke:query-values -w apps/api") fail("root package must expose smoke:query-values");
...
requireFile("apps/api/src/scripts/smoke-query-values.ts");
requireFile("apps/api/src/common/query-values.ts");
...
requireContains("apps/miniprogram/package.json", "tsc -p tsconfig.build.json");
requireFile("apps/miniprogram/tsconfig.build.json");
...
requireContains("apps/miniprogram/app.js", "showShareMenu");
requireContains("apps/miniprogram/utils/api.js", "wall-api.wdbzk.com/api");
requireContains("apps/miniprogram/pages/index/index.js", "/wallpapers");
requireContains("apps/miniprogram/pages/index/index.js", "this.load");
...
requireContains("apps/api/src/main.ts", '"trust proxy", 1');
...
requireContains("apps/api/package.json", "smoke:query-values");
requireContains("apps/api/src/scripts/smoke-query-values.ts", "Query value smoke passed");
...
requireContains("apps/api/src/modules/storage/storage-account.service.ts", "storageAccount.delete");
requireContains("apps/api/src/modules/storage/storage-account.service.ts", "removeProfile");
requireContains("apps/api/src/modules/admin/admin.service.ts", "positiveInt(query.page");
requireContains("apps/api/src/modules/tasks/tasks.service.ts", "positiveInt(page");
requireContains("apps/api/src/modules/import/old-cover-import.service.ts", "positiveInt(query.page");
requireContains("apps/api/src/modules/import/import.controller.ts", "nonNegativeInt(query.limit");
requireContains("apps/api/src/modules/admin/admin.service.ts", "requiredWallpaperIds");
requireContains("apps/api/src/modules/admin/admin.service.ts", "请先选择资源");
requireContains("apps/api/src/modules/storage/storage-account.service.ts", "isActive: false, isDefault: false");
...
requireContains("apps/api/src/modules/admin/admin.service.ts", "getChannelAccountForPublish");
...
requireContains("apps/admin/src/styles.css", "final-steps");
...
requireContains("scripts/smoke-admin.mjs", "assertInvalidQueryGuards");
requireContains("scripts/smoke-admin.mjs", "invalidQueryGuards");
requireContains("scripts/smoke-admin.mjs", "assertInvalidBulkGuards");
requireContains("scripts/smoke-admin.mjs", "invalidBulkGuards");
...
requireContains("scripts/smoke-upload-routing.mjs", "codex-smoke-upload-routing-");
requireContains("scripts/smoke-upload-routing.mjs", "channelAccountId");
...
requireContains("scripts/smoke-upload-routing.mjs", "assertInvalidStorageAccountIsClean");
requireContains("scripts/smoke-upload-routing.mjs", "invalid storage upload must reject before writing original or cover files");
requireContains("apps/api/src/modules/admin/admin.service.ts", "assertStorageReady");
requireContains("apps/api/src/modules/admin/admin.service.ts", "未配置可用网盘账号，不能开启自动处理");
...
requireContains("scripts/storage-auth.mjs", "CLI diagnostic helper");
requireContains("scripts/storage-auth.mjs", "do not create managed storage accounts");
...
requireContains("apps/api/src/modules/admin/admin.service.ts", "MINIPROGRAM_APPID");
...
requireContainsIfPresent(".github/workflows/deploy.yml", "npm run smoke:upload-routing");
